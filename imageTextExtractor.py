    ...
    def process_image(self, byte_image):
        ...
        # try:
            ...
            for crop_i,crop in enumerate(crops):
                ...
                # text_im_deskewed.save(str(crop_i)+".jpg")
...
if __name__ == "__main__":
    ...
    import time
    img = Image.open(r"/Users/prasingh/Prashant/Prashant/CareerBuilder/MyProject/AWS-Tessaract/data/invoice/AWS Textract Atradius Invoices - Invoice 13942092-001/Atradius Invoices - Invoice 13942092-001.jpg")
    st_time = time.time()
